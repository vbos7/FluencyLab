...
const aulas = [
  { titulo: "Aula 1 — Expressões idiomáticas",   duracao: "15:20", youtubeId: "YOUTUBE_ID_AQUI" },
  { titulo: "Aula 2 — Escrita formal em inglês", duracao: "13:10", youtubeId: "YOUTUBE_ID_AQUI" },
  { titulo: "Aula 3 — Pronúncia avançada",       duracao: "16:00", youtubeId: "YOUTUBE_ID_AQUI" },
];

export const metadata = { title: "Avançado — FluencyLab" };
...
export default function AvancadoPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-gray-900">Nível Avançado 🚀</h1>
        ...
        {aulas.map((aula, index) => (
          <div key={index} className="bg-white rounded-2xl border border-gray-200 overflow-hidden hover:shadow-md hover:border-blue-200 transition-all duration-200">
            ...
            <div className="px-5 py-4 flex items-center justify-between">
              ...
              <span className="text-xs bg-purple-50 text-purple-600 border border-purple-100 px-2.5 py-1 rounded-full font-medium">
                Aula {index + 1}
              </span>
            </div>
          </div>
