...
function CustomTooltip({
    ...
    return (
        <div className="rounded-2xl border border-slate-100 bg-white px-3.5 py-2.5 text-sm shadow-lg">
...
export function WeeklyChart({ data }: Props) {
    ...
    return (
        <div className="flex flex-col gap-4 rounded-2xl border border-[#dce8ff] bg-white p-5 shadow-[0_2px_16px_rgba(37,99,235,0.08)] sm:p-6">
            {/* Cabeçalho com título e alternador de métrica */}
            <div className="flex items-center justify-between">
                <div>
                    <p className="text-sm font-semibold text-slate-700">Evolução semanal</p>
                    <p className="mt-0.5 text-[11px] text-slate-400">Últimas 12 semanas</p>
                </div>
