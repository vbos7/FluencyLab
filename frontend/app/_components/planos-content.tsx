        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-2xl border-2 border-blue-500 p-6 flex flex-col gap-4 shadow-md">
            ...
            <button
              ...
              disabled={!proPlan}
              className="mt-2 w-full py-2.5 px-4 rounded-xl text-sm font-medium bg-blue-600 text-white hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Assinar Pro
            </button>
          </div>
