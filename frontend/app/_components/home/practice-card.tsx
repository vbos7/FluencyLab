...
export function PracticeCard({ xp, xpNeeded, level }: Props) {
    return (
        <div className="relative mb-7 flex h-28 items-center justify-between gap-3 overflow-hidden rounded-2xl border border-[#dce8ff] bg-white p-4 shadow-[0_2px_16px_rgba(37,99,235,0.08)] shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_4px_24px_rgba(37,99,235,0.13)] md:h-44 md:gap-6 md:p-7">
            {/* Barra lateral */}
